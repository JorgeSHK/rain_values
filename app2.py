...
API_KEY = "".join([
    chr(53), chr(53), chr(54), chr(54), chr(57), chr(98), chr(57), 
    chr(102), chr(49), chr(57), chr(51), chr(57), chr(57), chr(99), 
    chr(99), chr(50), chr(50), chr(97), chr(57), chr(99), chr(102), 
    chr(54), chr(57), chr(53), chr(48), chr(49), chr(52), chr(56), 
    chr(48), chr(49), chr(53), chr(102)
])
...
# ==============================================
# Configuración de Flask y despliegue
# ==============================================
@app.route('/')
def home():
    ...
    def keep_alive():
        while True:
            time.sleep(300)
            requests.get("https://jorgeshk.pythonanywhere.com")
    ...
    return Response(
        ...
        mimetype='text/html',
        headers={'Refresh': '5; url=https://jorgeshk.pythonanywhere.com/_stcore/'}
    )
